...
const Hero = ({ scrollRef }) => {
  ...
  return (
    ...
    >
      ...
      "
      >
        <h1 className="text-5xl md:text-6xl max-sm:text-3xl">
          Tasarımın Ötesinde Bir Sanat.
        </h1>
        <p className="text-sm md:text-md text-white font-gidole max-sm:text-[0.6rem]">
        ...
        <button className="md:px-8 md:py-4 bg-white text-black w-52 text-sm md:text-md font-gidole rounded-sm cursor-pointer px-4 py-4 hover:bg-gray-100 mt-5 max-sm:w-40 max-sm:px-3 max-sm:py-3">
